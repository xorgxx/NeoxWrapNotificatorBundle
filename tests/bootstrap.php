...
$autoloadPaths = [
    __DIR__ . '/../vendor/autoload.php',             // project root vendor when running tests from project root
    __DIR__ . '/../../vendor/autoload.php',          // fallback: if tests are executed from a nested context
